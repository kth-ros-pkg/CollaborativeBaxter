...
if __name__ == '__main__':
    ...
    classifier, class_names, std_slr, k, vocabulary = joblib.load("/home/ridgebackbaxter/CollaborativeBaxter_ws/src/object-recognition/src/baxter_demo/dataset_RPLv3.pkl")
