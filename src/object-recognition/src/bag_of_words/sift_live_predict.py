...
classifier, class_names, std_slr, k, vocabulary = joblib.load("dataset_RPLv1.pkl")

cap = cv2.VideoCapture(1)

# Create SIFT object
# sift = cv2.SIFT() # OpenCV 2
...
while(True):
    ...
    frame = cv2.drawKeypoints(frame, kp, None, flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS) # draw SIFT points
